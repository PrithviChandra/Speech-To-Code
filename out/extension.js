...
function activate(context) {
    ...
    let code_gen = vscode.commands.registerCommand("speechtocode.extensionMaker", async () => {
    ...
    let complexity = vscode.commands.registerCommand("speechtocode.time_complexity", async () => {
    ...
    //Python Bug Fixer
    let bug_fixer = vscode.commands.registerCommand("speechtocode.bug_fixer", async () => {
        //read selected code
        const activeEditor = vscode.window.activeTextEditor;
        if (activeEditor != null) {
            let line = activeEditor.selection;
    ...
    //Explain Code
    let code_explanation = vscode.commands.registerCommand("speechtocode.explain_code", async () => {
        //read selected code
        const activeEditor = vscode.window.activeTextEditor;
        if (activeEditor != null) {
            let line = activeEditor.selection;
    ...
    let translated = vscode.commands.registerCommand("speechtocode.translate_code", async () => {
        //read selected code
        const activeEditor = vscode.window.activeTextEditor;
        if (activeEditor != null) {
            let line = activeEditor.selection;
